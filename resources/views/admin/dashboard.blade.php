...
<div class="row">
		...
		<form action="" method="GET" autocomplete="off">
			{{ csrf_field() }}
			<div class="col-md-2">
                <p>Từ ngày: <input type="dateFrom" id="datepicker" class="form-control"></p>
                <button type="button" id="filter" name="filter" class="btn btn-primary btn-sm">Search</button>
			</div>
			<div class="col-md-2">
				<p>Đến ngày: <input type="dateTo" id="datepicker2" class="form-control"></p>
			</div>
			<div class="col-md-2">
				<p>
					Lọc theo: 
