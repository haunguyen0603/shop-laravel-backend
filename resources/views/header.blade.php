								...
								<div class="cart-item">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount"><a href="{{route('chitietsanpham',$product['item']['id'])}}">{{$product['qty']}}*<span>@if($product['item']['promotion_price']==0){{number_format($product['item']['unit_price'])}} @else {{number_format($product['item']['promotion_price'])}}@endif </span></a></span>
										</div>
									</div>
								</div>
							@endforeach
