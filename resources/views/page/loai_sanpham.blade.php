							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="{{route('themgiohang',$sp->id)}}"><i class="fas fa-cart-plus"></i></a>
						...
						@foreach($sp_khac as $sp_k)
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fas fa-cart-plus"></i></a>
